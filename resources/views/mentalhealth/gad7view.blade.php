...
<tr>
            <th>টেস্টের ধরন</th><th>উদ্বিগ্নতা নির্ণায়ক টেস্ট(GAD7)</th>
...
<tr>
            ...
            <th>পরিক্ষনটিতে আপনার ফলাফল</th><th>
  @if($new_data->Total >=16) 
   <h4 style="color:red"> তীব্র উদ্বিগ্নতায় ভুগছেন</h4>
   @elseif($new_data->Total >=11)
  <h4 style="color:orange"> মাঝারিভাবে তীব্র উদ্বিগ্নতায় ভুগছেন</h4>

  @elseif($new_data->Total >=6)
  <h4 style="color:yellow"> মাঝারি উদ্বিগ্নতায় ভুগছেন</h4>
  @else
  <h4 style="color:green"> হালকা উদ্বিগ্নতায় ভুগছেন</h4> 
